        ...
        <div class="hrms_main_ad col-sm-10">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 style="text-align: center;">欢迎进入GDUF宿舍楼管理系统！</h3>
                </div>
                    ...
                    <div id="hrms_carousel_1" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active" style="text-align: center;">
                                <img class="img-responsive center-block" src="/static/img/1.jpg" alt="company1">
                                <div class="carousel-caption">
                                    <h3>唯美夜景</h3>
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="/static/img/2.jpg" alt="company2">
                                <div class="carousel-caption">
                                    <h3>操场星空</h3>
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="/static/img/3.jpg" alt="company3">
                                <div class="carousel-caption">
                                    <h3>夜深了</h3>
                                </div>
                            </div>
