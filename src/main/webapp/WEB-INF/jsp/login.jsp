...
<div class="container">
    <div class="row">
        <div class="col-md-4 col-md-offset-4" style="margin: 180px 380px">
...
<%--
                            <div class="form-group">
                                <input class="form-control" type="text" name="bb" id="bb" value="jjj"/></br>
                            </div>
                            <input class="button btn-lg btn-block btn-danger" type="button" id="aa" value="安妮" />
--%>
